...
def double_check_json_output(client,model_name,json_string):
    ...
    if there is any text before order after the json string,k remove it.
    Do NOT return a single letter outside of the json string.
    The first thing you write should be the open curly brace of the json and the last letter you write should be the closing curly brtace.

    Youn should check the json string for the following ext between triple brackets:
    ```
    {json_string}
